            ...
            <div class="page-wrap">
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="{{ url('/') }}">
                            <div class="logo-img">
                               <img src="{{ asset('./admin_assets/Payroll-Final-Logo.png') }}" width="32">
                            </div>
                            <small class="text pl-2"><b>Payrool</b>System</small>
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">Create by Team Payrool @ST20</span>
